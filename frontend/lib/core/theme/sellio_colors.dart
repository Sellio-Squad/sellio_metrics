...
class SellioColors {
  ...
  static const dark = SellioColorScheme(
    authBackground: Color(0xFF0F0610),
    primary: Color(0xFF7A1540),
    primaryVariant: Color(0xFF2A0E18),
    secondary: Color(0xFFF5A623),
    secondaryVariant: Color(0xFF3D2E0F),
    surfaceLow: Color(0xFF1E1E2E),
    surface: Color(0xFF13131C),
    surfaceHigh: Color(0xFF2A2A3C),
    title: Color(0xF2F5F5F7),
    body: Color(0xCCE8E8ED),
    hint: Color(0x998E8E93),
    stroke: Color(0x333D3D48),
    onPrimary: Color(0xF2FFFFFF),
    disabled: Color(0xFF4A4A5A),
    red: Color(0xFFE54F40),
    errorVariant: Color(0xFF3B1A18),
    green: Color(0xFF1A9B2E),
    greenVariant: Color(0xFF1A2E1F),
    redVariant: Color(0xFF3B1A18),
    purpleVariant: Color(0xFF2A1A2E),
    semanticError: Color(0xFFE54F40),
    neutralsHint: Color(0xFF78788C),
    loadingDarkColors: [
      Color(0x267A1540),
      Color(0x997A1540),
      Color(0xFF7A1540),
    ...
    uploadImageTint: Color(0x50000000),
