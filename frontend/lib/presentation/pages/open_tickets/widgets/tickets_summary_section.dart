...
class TicketsSummarySection extends StatelessWidget {
  final TicketSummaryMetrics metrics;

  const TicketsSummarySection({super.key, required this.metrics});
      ...
      builder: (context, constraints) {
        ...
        if (isNarrow) {
          return Column(
            children: [
              Row(children: [
                Expanded(child: cards[0]), const SizedBox(width: AppSpacing.md),
                Expanded(child: cards[1]),
              ]),
              const SizedBox(height: AppSpacing.md),
              Row(children: [
                Expanded(child: cards[2]), const SizedBox(width: AppSpacing.md),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: bgColor, borderRadius: AppRadius.smAll),
