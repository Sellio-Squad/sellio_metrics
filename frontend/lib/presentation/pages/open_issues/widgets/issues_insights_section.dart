...
class IssuesInsightsSection extends StatelessWidget {
  final List<ScrumInsight> insights;

  const IssuesInsightsSection({super.key, required this.insights});
      ...
      child: Column(
        ...
        children: [
          ...
          ...insights.asMap().entries.map((entry) {
            ...
            final (Color leftBorderColor) = switch (insight.severity) {
